...
Gem::Specification.new do |s|
  ...
  s.authors = ["vihai"]
  s.date = "2012-01-10"
  s.description = "ActiveRest provides several useful actions for restful controllers"
  ...
  s.files = [
    ...
    "lib/active_rest/exceptions.rb",
    "lib/active_rest/model.rb",
    "lib/active_rest/model/interface.rb",
    "lib/active_rest/model/interface/attribute.rb",
