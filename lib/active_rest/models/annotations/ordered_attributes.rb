      ...
      module OrderedAttributes #:nodoc:
        ...
        module ClassMethods
          ...
          def attr_groups(groups = {})
            ...
            self.attribute_groups.nil? ? (self.attribute_groups = groups) : @attribute_groups.merge!(groups)
...
ActiveRecord::Base.send :include, ActiveRest::Models::Annotations::OrderedAttributes
